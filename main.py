...
async def remove_wins(interaction: discord.Interaction, player: discord.Member, server: str, amount: int):
    await interaction.response.defer()
    from remove_data import remove_player_data
    await remove_player_data(interaction, player, server, amount, "wins")
